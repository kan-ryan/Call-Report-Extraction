...
if __name__ == "__main__":
    ...
    df = load_transcripts()
    df_sample = df.sample(50)  # small test batch
    ...
    df_sample[["ticker", "date", "sentiment", "score"]].to_csv("data/processed/sample_sentiments.csv", index=False)



    print("\nSaved to data/processed/sample_sentiments.csv")
